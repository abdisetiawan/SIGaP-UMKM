...
<head>
    ...
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/openlayers/2.12/lib/OpenLayers.js">
    </script>
    <script type="text/javascript" src="{{asset('/dafmap')}}/js/FeaturePopups.js"></script>
    <script type="text/javascript">
        window.onload = function () {
            ...
            var icon = new OpenLayers.StyleMap({
                'externalGraphic': 'dafmap/img/icon/01.png',
                'graphicOpacity': 1.0,
                'graphicWith': 16,
                'graphicHeight': 32,
                'graphicYOffset': -32
    ...
    <style type="text/css">
        * {
        ...
        .popup>.popup-heading>.popup-heading-title {
            font-size: 22px;
        }

        .popup>.popup-heading>.close {
            position: absolute;
            right: 15px;
            top: 20px;
            font-weight: bold;
